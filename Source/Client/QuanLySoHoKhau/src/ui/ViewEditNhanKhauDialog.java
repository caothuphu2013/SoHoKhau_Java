...
public class ViewEditNhanKhauDialog extends javax.swing.JDialog {
    ...
    public ViewEditNhanKhauDialog(java.awt.Frame parent, boolean modal,HttpClient _client, NhanKhau _NhanKhau) {
        super(parent, modal);
        initComponents();
        Initialize();
    ...
    private void initComponents() {
        ...
        pnlBody.add(btnLuu, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 390, 135, 41));
        ...
        pnlBody.add(btnThayDoi, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 390, 135, 41));
        ...
        pnlBody.add(tfTonGiao, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 230, 140, -1));

        jPanel1.add(pnlBody);
        pnlBody.setBounds(70, 60, 660, 450);
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        switch (errorFlag) {
            case 0:
            {
                ...
                JSONResponse JSRes = HttpSupporter.sendGetRequest(client, HttpSupporter.URLSuaNhanKhau, list);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewEditNhanKhauDialog dialog = new ViewEditNhanKhauDialog(new javax.swing.JFrame(), true, null, null);
