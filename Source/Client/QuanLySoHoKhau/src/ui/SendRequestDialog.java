...
public class SendRequestDialog extends javax.swing.JDialog {
    ...
    HttpClient client;
    public SendRequestDialog(java.awt.Frame parent, boolean modal, HttpClient _client) {
        super(parent, modal);
        client = _client;
        initComponents();
    ...
    private void btnGuiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuiActionPerformed
        ...
        else
        {
            ...
            listParams.add(new Pair("nguoinhan", null));
            listParams.add(new Pair("stt", new String("-1")));
            listParams.add(new Pair("tieude", tieuDe));
            listParams.add(new Pair("noidung", noiDung));
            listParams.add(new Pair("traloi", null));
            // Code here
            ...
            ChuHoApp parent = (ChuHoApp)this.getParent();
            parent.LoadDanhSachGuiYeuCau();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SendRequestDialog dialog = new SendRequestDialog(new javax.swing.JFrame(), true, null);
